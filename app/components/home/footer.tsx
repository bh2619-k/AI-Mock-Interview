...
const Footer = () => {
  return (
    <footer className="md:h-[400px]  mb-auto min-h-[300px] items-center md:items-start flex flex-col gap-10 mt-20 text-white py-10 rounded-t-[45px] p-6 md:px-20 max-w-full sm:max-w-[540px] md:max-w-[720px] lg:max-w-[960px] xl:max-w-[1180px] mx-auto  bg-dark">
      <div className="w-fit">
        <Link href={"/"}>
          <h3 className="text-3xl border-[#bec8ff] border-[1px]  rounded-3xl px-3.5 py-2.5 font-semibold flex items-center">
      ...
      <div className="md:text-left text-center">
        <span>
          2025 takeInt - Made with{" "}
          <span className="underline">NextJs & Vapi</span> by{" "}
          <span className="underline">bh</span>
        </span>
      </div>
    </footer>
  );
