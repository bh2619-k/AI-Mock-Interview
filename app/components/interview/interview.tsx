  ...
  return (
    <article className="mt-8 flex flex-col gap-10">
      ...
      <section className="flex gap-12 flex-1 items-center flex-row justify-center w-full">
        <div className="flex-col gap-y-1 flex items-center justify-center h-[320px] border-2 border-[#CAC5FE] rounded-2xl w-full  md:w-1/2 bg-gradient-to-b from-[#181537] to-[#0C0B16]">
          <div className="relative flex flex-col items-center justify-center">
            {isSpeaking && (
              <>
                <div className="absolute w-[120px] h-[120px] bg-[#CAC5FE] bg-opacity-45 rounded-full animate-ping"></div>
                <div className="absolute w-[120px] h-[120px] bg-[#CAC5FE] bg-opacity-30 rounded-full animate-ping delay-[1s]"></div>
              </>
            )}
            <div className="relative bg-gradient-to-b from-[#FFFFFF] to-[#CAC5FE] rounded-full flex items-center justify-center w-[140px] h-[140px] z-10">
              <Image
        ...
        <div className=" hidden md:flex relative flex-col gap-y-1 max-w-[500px] h-[320px]  border-2 border-[#CAC5FE] flex-1 rounded-2xl items-center justify-center w-1/2 bg-gradient-to-b from-[#1A1C20] to-[#08090D]">
          ...
          <h3 className="text-3xl font-semibold">BH (You)</h3>
        </div>
      </section>
      <section className=" rounded-full flex-col flex item-center justify-center gap-4 border-2px border-[#4B4D4F66]">
        {callStart && (
          <span className="bg-gradient-to-b from-[#1A1C20] to-[#08090D] text-center p-4 text-lg">
            {lastMessage}
          </span>
        )}
